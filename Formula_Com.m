...
% sizeCom=dCom/0.001+1;
sizeCom=6;
Result_Com=zeros(sizeCom,9);
%% 经济参数循环
data=[0.06 0.006 z1 0.009];%宸ヤ綔鐐瑰潗鏍囧?
% data=[0.05 0.006 z1 0.009];
k=6;
for n=1:k
    Com=Com_min+(n-1)*0.001;
    % n=(Com-Com_min)/0.01+1;
B=data(1);
% Com=data(2);
acc_r=data(3);
Cin=data(4);
...
tableB = array2table(Result_Com);
saveName = 'Result_Com.xlsx';
writetable(tableB, saveName, "Sheet", "运营维护费用");