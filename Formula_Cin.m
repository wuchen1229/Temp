...
sizeCin=dCin/0.001+1;
% sizeCom=6;
Result_Cin=zeros(sizeCin,9);
%% 经济参数循环
data=[0.06 0.006 z1 0.009];%宸ヤ綔鐐瑰潗鏍囧?
% data=[0.05 0.006 z1 0.009];
k=dCin/0.001+1;
for n=1:k
    Cin=Cin_min+(n-1)*0.001;
B=data(1);
Com=data(2);
acc_r=data(3);
% Cin=data(4);
...
tableB = array2table(Result_Cin);
saveName = 'Result_Cin.xlsx';
writetable(tableB, saveName, "Sheet", "初始投资成本");